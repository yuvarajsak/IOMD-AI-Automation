...
export class ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheTargetApplicationFeaturesLegacyIomdFeaturesTargetPage extends BasePage {
  constructor() {
    super("ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheTargetApplicationFeaturesLegacyIomdFeaturesTargetPage");
  }
  ...
  async userClicksSendcodeButtonByOnlyNameInTheWebsite(sendcode: string): Promise<void> {
    await this.executeLegacyStep("user clicks \"<sendcode>\" button by only name in the Website", { "sendcode": sendcode });
  }
  ...
  async userClicksCreateaccButtonByOnlyNameInTheWebsite(createacc: string): Promise<void> {
    await this.executeLegacyStep("user clicks \"<createAcc>\" button by only name in the Website", { "createacc": createacc });
  }
...
export const tovalidatetheautofilloptionandinteractionaregettingcapturedcorrectlyinthetargetapplicationfeatureslegacyiomdfeaturestargetpage = new ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheTargetApplicationFeaturesLegacyIomdFeaturesTargetPage();
