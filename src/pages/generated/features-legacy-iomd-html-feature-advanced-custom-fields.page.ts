...
export class I2iValidatesAutofillFunctionalityInAdvancedCustomFieldsWebsiteFeaturesLegacyIomdHtmlFeatureAdvancedCustomFieldsPage extends BasePage {
  constructor() {
    super("I2iValidatesAutofillFunctionalityInAdvancedCustomFieldsWebsiteFeaturesLegacyIomdHtmlFeatureAdvancedCustomFieldsPage");
  }
...
export const i2ivalidatesautofillfunctionalityinadvancedcustomfieldswebsitefeatureslegacyiomdhtmlfeatureadvancedcustomfieldspage = new I2iValidatesAutofillFunctionalityInAdvancedCustomFieldsWebsiteFeaturesLegacyIomdHtmlFeatureAdvancedCustomFieldsPage();
