...
export class ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheBluestarcoffeeroastersApplicationFeaturesLegacyIomdFeaturesBlueStarCoffeeRoastersPage extends BasePage {
  constructor() {
    super("ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheBluestarcoffeeroastersApplicationFeaturesLegacyIomdFeaturesBlueStarCoffeeRoastersPage");
  }
  ...
  async userEntersDataInSignupPageForBluestarcoffeeWebsite(): Promise<void> {
    await this.executeLegacyStep("user enters data in signup page for BlueStarCoffee website", {});
  }
...
export const tovalidatetheautofilloptionandinteractionaregettingcapturedcorrectlyinthebluestarcoffeeroastersapplicationfeatureslegacyiomdfeaturesbluestarcoffeeroasterspage = new ToValidateTheAutofillOptionAndInteractionAreGettingCapturedCorrectlyInTheBluestarcoffeeroastersApplicationFeaturesLegacyIomdFeaturesBlueStarCoffeeRoastersPage();
