Feature: I2i_Validates autofill functionality in Coravin website

  @iomd_htmlTest @all_html
  Scenario Outline: TCs User validate autofill functionality in Coravin
    ...
    Examples: 
      | url                                    | SignIn  | Signup  | Forgotpassword  | checkout | payment |
      | https://iomdqaenv.web.app/coravin.html | Sign In | Sign Up | Forgot Password | Checkout | Payment |

  @iomd_html @all @coravin_html
  Scenario Outline: TC_01 User validate autofill functionality on signin form in Coravin
    ...
    Examples: 
      | url                                    | SignIn  |
      | https://iomdqaenv.web.app/coravin.html | Sign In |

  @iomd_html @all @coravin_html 
  Scenario Outline: TC_02 User validate autofill functionality on signup form in Coravin
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Then user clicks "<submit>" button by only name in the Website
    ...
    Examples: 
      | url                                    | Signup  | submit | business |
      | https://iomdqaenv.web.app/coravin.html | Sign Up | Submit | Web      |

  @iomd_html @all @coravin_html
  Scenario Outline: TC_03 User validate autofill functionality on forgotpassword form in Coravin
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                    | Forgotpassword  |
      | https://iomdqaenv.web.app/coravin.html | Forgot Password |

  @iomd_html @all @coravin_html @testhtml
  Scenario Outline: TC_04 User validate autofill functionality on checkout form in Coravin
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                    | checkout |
      | https://iomdqaenv.web.app/coravin.html | Checkout |

  @iomd_html @all @coravin_html
  Scenario Outline: TC_05 User validate autofill functionality on payment form in Coravin
    When user completes onboarding flow with card data
    When user launches the website "<url>"
    Then user clicks "<payment>" button by only name in the Website
    When user enables the Extension
    ...
    Examples: 
      | url                                    | payment |
      | https://iomdqaenv.web.app/coravin.html | Payment |
