Feature: I2i_Validates autofill functionality in Walmart website

  @iomd_html @all
  Scenario Outline: TC_01 User validate autofill functionality on signin form in Walmart
    ...
    Examples: 
      | url                                    | SignIn  |
      | https://iomdqaenv.web.app/walmart.html | Sign In |

  @iomd_html @all
  Scenario Outline: TC_02 User validate autofill functionality on signup form in Walmart
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                    | Signup  |
      | https://iomdqaenv.web.app/walmart.html | Sign Up |


  @iomd_html @all
  Scenario Outline: TC_03 User validate autofill functionality on checkout form in Walmart
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                    | checkout |
      | https://iomdqaenv.web.app/walmart.html | Checkout |

  @iomd_html @all
  Scenario Outline: TC_04 User validate autofill functionality on payment form in Walmart
    ...
    Examples: 
      | url                                    | payment |
      | https://iomdqaenv.web.app/walmart.html | Payment |
