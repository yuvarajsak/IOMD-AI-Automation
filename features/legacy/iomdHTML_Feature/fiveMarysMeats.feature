Feature: I2i_Validates autofill functionality in FiveMarysMeats website

  @iomd_html @all
  Scenario Outline: TC_01 User validate autofill functionality on signin form in FiveMarysMeats
    ...
    Examples: 
      | url                                           | SignIn  |
      | https://iomdqaenv.web.app/fiveMarysMeats.html | Sign In |

  @iomd_html @all
  Scenario Outline: TC_02 User validate autofill functionality on signup form in FiveMarysMeats
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                           | Signup  |
      | https://iomdqaenv.web.app/fiveMarysMeats.html | Sign Up |

  @iomd_html @all
  Scenario Outline: TC_03 User validate autofill functionality on forgotpassword form in FiveMarysMeats
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                           | Forgotpassword  |
      | https://iomdqaenv.web.app/fiveMarysMeats.html | Forgot Password |

  @iomd_html @all
  Scenario Outline: TC_04 User validate autofill functionality on checkout form in FiveMarysMeats
    When user completes onboarding flow
    When user navigates to the settings application and enables the extension
    Then user navigates to the safari application
    When user launches the website "<url>"
    ...
    Examples: 
      | url                                           | checkout |
      | https://iomdqaenv.web.app/fiveMarysMeats.html | Checkout |

  @iomd_html @all
  Scenario Outline: TC_05 User validate autofill functionality on payment form in FiveMarysMeats
    ...
    Examples: 
      | url                                           | payment |
      | https://iomdqaenv.web.app/fiveMarysMeats.html | Payment |
